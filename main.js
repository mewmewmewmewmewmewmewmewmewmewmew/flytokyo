...
import { TrainSystem } from './train.js?v=12.44';
import { FISH_U, fishUniforms, FISH_PROJ_GLSL, FISH_FRAG_GLSL, TOON_GLSL } from './fisheye.js?v=12.44';
import { CHARACTERS, DEFAULT_CHARACTER } from './characters.js?v=12.44';
...
function initScene(collision) {
  ...
  (function animate() {
    ...
    if (mapsLinkEl) {
      ...
      // log₂ scale × 1.5: y≈4m → zoom 20; y≈50m → zoom 20; y≈500m → zoom 17; y≈2000m → zoom 14.
