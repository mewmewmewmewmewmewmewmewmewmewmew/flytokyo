...
import { TrainSystem } from './train.js?v=12.46';
import { FISH_U, fishUniforms, FISH_PROJ_GLSL, FISH_FRAG_GLSL, TOON_GLSL } from './fisheye.js?v=12.46';
import { CHARACTERS, DEFAULT_CHARACTER } from './characters.js?v=12.46';
